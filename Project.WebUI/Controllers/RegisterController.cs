...
namespace Project.WebUI.Controllers
{
    public class RegisterController : Controller
    {
        ...
        public ActionResult RegisterNow(AppUserVM apvm)
        {
            ...
            _apRep.Add(appUser); //öncelikle bunu eklemelisiniz...Cünkü AppUser'in ID'si ilk basta olusmalı...Cünkü siz birebir ilişkide AppUser zorunlu olan alan Profile ise opsiyonal alan olarak olusturdunuz... Dolayısıyla ilk basta AppUser'in ID'si SaveChanges ile olusmalı ki sonra Profile'i rahatca ekleyebilelim...
